...
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.43\textwidth}{\raggedright\MakeUppercase{Recomendaciones accionables para e-commerce de PyMEs en Buenos Aires}}} % El parámetro 0.43 puede modificarse para tener más espacio en la columan del medio, y que así el título de la tesis entre mejor.
			{
				\raisebox{1.5ex}{%
...
% Numeraci\'on de tablas por cap\'{\i}tulo (Tabla 6.1, Tabla 6.2, ...), igual que las figuras.
...
\includepdf[
  ...
  trim=0 0 0 0,
  clip
]{cover/284ef8e2-6978-41c9-868c-e8f23e315f9b.pdf}
\clearpage
	\input{chapters/title}
	\tableofcontents
	\input{chapters/chapter00}
	\input{chapters/chapter01-marco}
	\input{chapters/chapter02-estado}
	\input{chapters/chapter03-analisis-estrategico}
	\input{chapters/chapter05-requerimientos}
	\input{chapters/chapter04-tecnologias}
	...
	\appendix
	\input{chapters/appendix/annex.tex}
\end{document}
