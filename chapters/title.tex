\begin{titlepage}
    ...
    {\textbf{\fontsize{16}{18}\selectfont SISTEMA DE RECOMENDACIONES ACCIONABLES PARA E-COMMERCE PYME EN BUENOS AIRES} \par}
    \vspace{0.5cm}

    {\textbf{\fontsize{14}{16}\selectfont Palomino Gayoso, Micaela} \par}
