...
\begin{tabular}{|m{3.5cm}|m{2.5cm}|m{2.5cm}|}
\hline
\rowcolor[HTML]{1e3a5f}
\textcolor{white}{\textbf{Atributo}} & \textcolor{white}{\textbf{Nubelytics}} & \textcolor{white}{\textbf{Este proyecto}} \\
\hline
\rowcolor[HTML]{FFFF00}
Integración con Tiendanube & \cellcolor{white}{\checkmark\ Sí} & \cellcolor{white}{\checkmark\ Sí} \\
\hline
\rowcolor[HTML]{FFFF00}
Analytics de conversión / embudo & \cellcolor{white}{\checkmark\ Sí} & \cellcolor{white}{Parcial} \\
\hline
\rowcolor[HTML]{FFFF00}
Insights en lenguaje natural con IA & \cellcolor{white}{\checkmark\ Sí} & \cellcolor{white}{\checkmark\ Sí} \\
\hline
\rowcolor[HTML]{FFFF00}
Gestión de inventario & \cellcolor{white}{\ding{55}\ No} & \cellcolor{white}{\checkmark\ Sí} \\
\hline
\rowcolor[HTML]{FFFF00}
Estacionalidad por rubro & \cellcolor{white}{\ding{55}\ No} & \cellcolor{white}{\checkmark\ Sí} \\
\hline
\rowcolor[HTML]{FFFF00}
Feedback loop sobre acciones ejecutadas & \cellcolor{white}{\ding{55}\ No} & \cellcolor{white}{\checkmark\ Sí} \\
\hline
\rowcolor[HTML]{FFFF00}
Validación de efectividad de recomendaciones & \cellcolor{white}{\ding{55}\ No} & \cellcolor{white}{\checkmark\ Sí} \\
\hline
\end{tabular}
\end{table}
