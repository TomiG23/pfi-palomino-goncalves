...
Resta definir si el acceso a la base de datos se realizará mediante un \emph{Object-Relational Mapping} (ORM) o mediante SQL directo; a la fecha de esta entrega, esta decisión permanece abierta. La opción que se perfila como más probable es la incorporación de un ORM como Prisma, por su carácter declarativo y su adopción extendida en el ecosistema de Node.js, aunque no debe interpretarse como una decisión ya tomada. El diseño del modelo de datos correspondiente excede el alcance de la presente sección y será abordado en el capítulo dedicado a dicho modelo.
